...
import nsu.fit.g14201.marchenko.phoenix.utils.SDCardNotReadyException;
import nsu.fit.g14201.marchenko.phoenix.utils.VideoSavingUtils;

public class RecordingFragmentBackup extends InferiorFragment {
    private RecordingContract.Presenter presenter;
    private AutoFitTextureView textureView;

    private File file;

    public static RecordingFragmentBackup newInstance() {
        return new RecordingFragmentBackup();
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        try {
            file = VideoSavingUtils.getOutputMediaFile();
            Log.d(App.getTag(), file == null ? "null" : "not null");

        } catch (SDCardNotReadyException e /* | IOException e*/) {
            Log.d(App.getTag(), "Something very expected happened");
            e.printStackTrace();
        }
    }
...
//            RecordingFragment.this.cameraDevice = cameraDevice;
...
//            mCameraOpenCloseLock.release();
//            cameraDevice.close();
//            RecordingFragment.this.cameraDevice = null;
//        }
//
//        @Override
...
//                IncorrigibleErrorDialog.newInstance(getString(R.string.request_permission))
...
//            IncorrigibleErrorDialog.newInstance(getString(R.string.camera_error))
//                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
//        }
//    }
...
//     */
//    public static class IncorrigibleErrorDialog extends DialogFragment {
//
//        private static final String ARG_MESSAGE = "message";
//
//        public static IncorrigibleErrorDialog newInstance(String message) {
